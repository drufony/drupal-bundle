...
class RouteCompiler extends BaseRouteCompiler
{
    ...
    private static function compilePattern(Route $route, $pattern, $isHost)
    {
        ...
        // Special Drupal route expression
        if (!$isHost) {

            // Match the rest of the URL. Trailing slash is optional.
            $regexp .= '[/]?.*';

            // Force the dumper to treat the regular expression string as a regular expression.
            if (empty($variables)) {
                $variables[] = 'p0';
            }
        }
